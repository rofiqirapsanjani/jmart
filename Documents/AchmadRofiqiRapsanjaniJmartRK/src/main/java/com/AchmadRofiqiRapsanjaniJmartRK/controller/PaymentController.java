...
public class PaymentController implements BasicGetController<Payment> {
    ...
    public static @JsonAutowired(value = Payment.class, filepath = "C:\\Users\\vicky\\Desktop\\AchmadRofiqiRapsanjaniJmartRK\\src\\payment.json")
    ...
    @GetMapping("/{id}/page")
    @ResponseBody List<Payment> getInvoices(@PathVariable int id, @RequestParam(defaultValue="0") int page, @RequestParam(defaultValue="5") int pageSize){
    ...
    @ResponseBody List<Payment> getMyInvoices(@PathVariable int id, @RequestParam(defaultValue="1") int page, @RequestParam(defaultValue="5") int pageSize){
