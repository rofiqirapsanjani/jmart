...
public class ProductController implements BasicGetController<Product>{
    public static @JsonAutowired(value= Product.class, filepath="C:\\Users\\vicky\\Desktop\\AchmadRofiqiRapsanjaniJmartRK\\src\\randomProductList.json") JsonTable<Product> productTable;
